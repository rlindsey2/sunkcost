...
import {
  ...
  hardwareLabel, hardwareProduct, indefiniteArticle, kvWorking, longestContext, lowerFirst, machinesConsidered,
  machineVerdict, median, meetAtShorterContext, modelLabel, modelVerdict, otherQuantisations, pageShell,
  priceRivals, priceWithScope, priceWithScopeText, rowFor, runnersFor, runsOnlyOn, runsOnlyThere,
  shortHardwareLabel, SIZE_BANDS, slug, speedWithBasis, stack, strongestShared, tierLabel, tierName, tierScale,
  TITLE_MAX, titleOf, verdictLine, type Runner, type SharedMachine, type ShorterFit
} from '../src/pagekit';
import {
