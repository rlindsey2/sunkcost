...
import {
  ...
  LEADERBOARD_CARD, leaderboardCard, MEMORY_CARD, memoryCard, MONTHLY_CARD, monthlyCostCard, TOKEN_COST_CARD, tokenCostCard,
} from '../src/list-card';
...
const list: [string, string][] = [
  ...
  [MONTHLY_CARD, monthlyCostCard(data, FONT)],
];
